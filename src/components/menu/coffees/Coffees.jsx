...
export default function Menu() {
  const coffees = [
    {
      ...
      price: "18zł",
      alt: "Szklana filiżanka z kawą americano",
    },
    {
      title: "Cappucino",
      description:
      ...
      price: "20zł",
      alt: "Szklana filiżanka z trójwarstwowym cappuccino",
    },
    {
      title: "Espresso",
      description:
    ...
    },
    {
      ...
      price: "25zł",
      alt: "Szklana filiżanka z kawą flat white",
    },
    {
      title: "Latte",
      description: "Mięciutka, mleczna i przyjazna. Jak uśmiech w filiżance.",
      img: "/menu-coffees/latte-small.webp",
      price: "29zł",
      alt: "Porcelanowa filiżanka z kawą latte",
    },
    {
      title: "Lura",
      description:
        "Bo nie każdy lubi mocną kawę. U nas też możesz pójść na lekkie, wodniste doznania bez oceny.",
      img: "/menu-coffees/lura-small.webp",
      price: "10zł",
      alt: "Porcelanowa filiżanka z czarną kawą lura",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="menu-coffees mt-5 grid auto-rows-auto grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3 xl:gap-10">
        {coffees.map(({ title, description, img, price, alt }, index) => (
          <CoffeeCard
            key={index}
            title={title}
