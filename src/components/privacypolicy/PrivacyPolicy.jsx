...
export default function PrivacyPolicy() {
  return (
    <div className="privacy-policy bg-cream" id="privacy-policy">
      <div className="privacy-policy-container wrapper">
        <Link
          to="/"
          className="privacy-policy-link text-orange hover:text-orange-hover mb-8 inline-flex items-center gap-2"
        >
        ...
        <ol className="privacy-policy-list text-body ml-5 list-decimal">
          <li>
          ...
          <li>
            ...
            <p>
              Krótko mówiąc - są tu tylko po to, żeby wszystko działało tak, jak
              powinno.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              Analytics, ani z systemów reklamowych. Nikt nie analizuje Twojego
              zachowania, nikt niczego nie profiluje.
            </p>
          </li>
          <li>
            ...
            <ul className="ml-10 list-disc">
              ...
              <li>
                pełnej kontroli nad ustawieniami prywatności po swojej stronie.
              </li>
            </ul>
          </li>
        </ol>
